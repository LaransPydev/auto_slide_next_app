...
export function Navbar() {
    return (
        <nav className="flex items-center justify-between px-6 py-4 bg-white shadow-sm font-sans">
            ...
            {/* Navigation Links */}
            <div className="hidden xl:flex items-center gap-6 text-xs font-bold text-gray-700 uppercase tracking-wide">
